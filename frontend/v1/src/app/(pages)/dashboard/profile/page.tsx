...
const ProfilePage = () => {
  ...
  const handleChangeName = async () => {
    try{
      setLoading((prev) => ({ ...prev, name: true }))
        ...
        const response = await fetch("https://checkche-backend.onrender.com/user/update-name", {
      method: "PUT",
      credentials: "include",
      headers: {
  ...
  const handleChangeUsername = async () => {
    ...
    try{
      setLoading((prev) => ({ ...prev, username: true }))
        ...
        const response = await fetch("https://checkche-backend.onrender.com/username/update-username", {
      method: "PUT",
      credentials: "include",
      headers: {
        "Content-Type": "application/json",
  ...
  const handleLogout = async () => {
    try {
        const response = await fetch("https://checkche-backend.onrender.com/auth/logout", {
            method: "GET",
